...
import { FileCheck, User as UserIcon, Calendar, ArrowRight } from 'lucide-react';
...
const ClaimCard = ({ claim }: ClaimCardProps) => {
  ...
  const isMyClaim = user && (typeof claim.claimantId === 'object' 
                ...
                <div className="flex items-center gap-3 text-sm text-gray-600 bg-gray-50 p-2 rounded-lg">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="font-semibold text-gray-700 truncate">
                      {isMyClaim ? 'You' : (typeof claim.claimantId === 'object' ? claim.claimantId.name : 'Claimant')}
                    </span>
                  </div>
                </div>
              </div>
