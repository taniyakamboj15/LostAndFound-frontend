...
// Types
import { TransferStatus, Claim } from '@app-types/index';

// Utilities
// No extra utilities needed here yet
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
                          ...
                          <div className="flex justify-between items-start">
                            <div className="space-y-1">
                              ...
                              <h3 className="text-lg font-bold text-gray-900 line-clamp-1">
                                  {typeof transfer.itemId === 'object' ? transfer.itemId.description : 'Unknown Item'}
                                </h3>
                          ...
                          <div className="bg-gray-50 rounded-2xl p-4 flex items-center justify-between gap-4 relative">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <p className="text-sm font-bold text-gray-900">
                                    {typeof transfer.fromStorageId === 'object' ? transfer.fromStorageId.name : 'Original Branch'}
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    {typeof transfer.fromStorageId === 'object' ? transfer.fromStorageId.city : 'Original Branch'}
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex-1 text-right">
                              ...
                              <div className="flex items-center gap-2 justify-end">
                                <div className="text-right">
                                  <p className="text-sm font-bold text-gray-900">
                                    {typeof transfer.toStorageId === 'object' ? transfer.toStorageId.name : 'Target Branch'}
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    {typeof transfer.toStorageId === 'object' ? transfer.toStorageId.city : 'Target Branch'}
                                  </p>
                                </div>
                             ...
                             <div className="space-y-1">
                              ...
                              <div className="space-y-1 text-right">
                                 ...
                                 <p className="font-mono text-xs text-blue-600 font-bold">
                                   #{typeof transfer.claimId === 'object' ? (transfer.claimId as Claim)._id?.substring((transfer.claimId as Claim)._id.length - 6).toUpperCase() : transfer.claimId?.substring(transfer.claimId.length - 6).toUpperCase()}
                                 </p>
                              </div>
                          </div>
                        </div>
      ...
      <Modal
        ...
        title={updateData.status === TransferStatus.IN_TRANSIT ? 'Ship Item' : 'Receive Item'}
        size="md"
      >
